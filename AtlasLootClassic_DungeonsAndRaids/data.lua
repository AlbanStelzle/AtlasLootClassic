...
data["BlackfathomDeepsRaid"] = {
    ...
    LevelRange = GetForVersion({ 25, 25, 60 }),
    items = {
        { -- BFDBaronAquanis
            name = AL["Baron Aquanis"],
            npcID = 202699,
            ...
            AtlasMapBossID = 7,
            [NORMAL_DIFF] = {
                { 1, 209421 }, -- Cord of Aquanis
                { 2, 209828 }, -- Sub-Zero Pauldrons
                { 3, 209825 }, -- Droplet Choker
                { 4, 204807 }, -- Fathomblade
                { 5, 209423 }, -- Flowing Scarf
                { 6, 209422 }, -- High Tide Choker
                { 7, 209676 }, -- Shoulderguards of Crushing Depths
                { 8, 209590 }, -- Cracked Water Globe
                { 9, 211852 }, -- Handwraps of Befouled Water
        ...
        { -- BFDGhamoora
            ...
            [NORMAL_DIFF] = {
                ...
                { 4, 209424 }, -- Shell Plate Barrier
                { 5, 209824 }, -- Shimmering Shoulderpads
                { 6, 209418 },
                { 7, 209524 },
                { 8, 209436 },
                { 9, 209678 },
...
data["GnomereganRaid"] = {
    ...
    ContentType = RAID10_CONTENT,
    LoadDifficulty = RAID10_DIFF,
    LevelRange = GetForVersion({ 40, 40, 60 }),
    items = {
        { -- GnTechbot
            name = AL["Techbot"],
            npcID = 6231,
